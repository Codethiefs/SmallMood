...
class debug{
	...
	public static function shutdown(){
		//全局变量debug不为1的时候则 不显示调试信息，主要是为了某些页面不想要显示该信息
		if($GLOBALS['debug']!=1)
		{
			return ;
		}
	...
	public static function addmsg($msg,$type=0){
		...
		switch ($type){
			case 0 :self::$errors[] = $msg;break;
			case 1 :self::$infos[]  = $msg;break;
			case 2 :self::$incfiles[]  = $msg;break;
			case 3 :self::$sqls[]    = $msg;break;
