...
return array(
    ...
    'TMPL_ACTION_ERROR' => SMALL_PATH . 'Tpl/dispatch_jump.tpl', // 默认错误跳转对应的模板文件
    'TMPL_ACTION_SUCCESS' => SMALL_PATH . 'Tpl/dispatch_jump.tpl', // 默认成功跳转对应的模板文件
    'TMPL_EXCEPTION_FILE' => SMALL_PATH . 'Tpl/think_exception.tpl',// 异常页面的模板文件
